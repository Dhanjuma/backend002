...
console.log(person1.fname +" "+ person1.lname + " is a " + person1.job.oc1 + " learning " + person1.job.oc2 + " with his "+ person1.devices[1]);
...
console.log(person3.fname + person3.lname + " is an " + person3.job.oc2 + " who uses " + person3.devices[3]);
...
console.log( person4.fname+" "+person4.lname+" is the "+person4.job.oc2);
